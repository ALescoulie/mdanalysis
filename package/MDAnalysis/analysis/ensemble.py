...
from MDAnalysis.exceptions import FileFormatWarning, SelectionError, \
    NoDataError, MissingDataWarning
...
class Ensemble(object):
    ...
    *universe_kwargs*
    ...
    def _load_universe_from_dir(**universe_kwargs) -> Optional[Universe]:
        ...
        try:
            return Universe(os.path.abspath(top[0]), trj, **universe_kwargs)
    ...
    def add_system(self, key, universe: Universe):
        ...
        Existing Universe object or trajectory and topology path. Ensure
